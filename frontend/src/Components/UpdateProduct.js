...
navigate('/stocks')
    ...
    return (
        <div>
            <div><h1 className='flex justify-center text-3xl font-bold  text-green-600'>New purchase Price of {id}</h1></div>
                    ...
                    <form className="space-y-6 px-40 py-2" onSubmit={(e)=>handleOnSubmit(e)}>
                        <div>
                            <div className="flex items-center justify-between">
                                <label htmlFor="password" className="block text-sm font-medium leading-6 text-gray-900">Enter New Purchase Price of {id} </label>
                            </div>
                            <div className="mt-2">

            ...
            <div className='gridstyle grid grid-cols-4'>
                ...
                <div className='border border-gray-100 justify-center col-span-2'>
                    <form class="space-y-6 px-40 py-2" action="/" method="POST">
                        <div>
                            <label for="Item Name" class="block text-sm font-medium leading-6 text-gray-900">Spent On
</label>
                        ...
                        <div>
                            <div class="flex items-center justify-between">
                                <label for="ammount" class="block text-sm font-medium leading-6 text-gray-900">SpentAmmount</label>
                            </div>
                            <div class="mt-2">
                        ...
                        <div>
                            <button type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add Expence</button>
                        </div>
                    </form>
